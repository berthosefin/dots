...
class RecorderService extends Service {
  ...
  _path = GLib.get_home_dir() + "/Vidéos/Screencasting";
  _recording = false;
  ...
  async screenshot() {
    try {
      ...
      const path = GLib.get_home_dir() + "/Images/Screenshots";
...
Widget.widgets["recorder/indicator-button"] = (props) =>
  Widget({
    ...props,
    className: "recorder",
    type: "button",
...
Widget.widgets["screenshot/button"] = (props) =>
  Widget({
    ...props,
    type: "button",
