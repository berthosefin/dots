  ...
  children: [
    {
      ...
      children: [
        ...
        {
          type: "box",
          children: [{ type: "audio/speaker-percent-label" }, "%"],
        },
...
const arrowToggle = ({ icon, label, connection, toggle, name, toggleOn }) => ({
  type: "box",
  connections: [
    [connection[0], (w) => w.toggleClassName("active", connection[1]())],
  ],
...
const themeToggle = {
  ...
  connections: [
    [QSMenu, (w) => w.toggleClassName("on", QSMenu.opened === "theme")],
  ],
};
...
Widget.widgets["quicksettings/popup-content"] = () =>
  Widget({
    type: "box",
          ...
          },
          {
            ...
            children: Service.Asusctl?.available
              ? [
                  {
                    type: "box",
                    children: [asusmodeToggle, asusctlToggle, dndToggle],
                  },
                  {
                    type: "box",
                    children: [appmixerToggle, themeToggle, muteToggle],
                  },
                ]
              : [
...
Widget.widgets["quicksettings/panel-button"] = () =>
  Widget({
    type: "button",
